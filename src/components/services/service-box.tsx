...
function ServiceBox({ title, href, description, className }: ServiceBoxProps) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <div className="flex-1 relative z-10 border-x border-b text-center rounded-b-[10px] p-5 !pt-10">
